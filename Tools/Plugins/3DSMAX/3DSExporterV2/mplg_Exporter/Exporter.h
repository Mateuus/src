...
public:
	...
	std::vector<lod_s> m_LOD;
	int		m_LodMinFaces;
	char		m_LodDistances[512];
	char		m_LodPercents[512];
	int		ConstructLODArray(char *lod_percents, char *lod_distances);
...
extern	void		ThrowError(const char* strText, const char* strFilename = __FILE__, int line = __LINE__);
